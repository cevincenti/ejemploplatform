...
using CliDemo.Application.UseCase.V1.PersonOperation.Commands.Create;
using CliDemo.Application.UseCase.V1.PersonOperation.Commands.Update;
using CliDemo.Application.UseCase.V1.PersonOperation.Queries.GetList;
using CliDemo.Domain.Dtos;
